...
public partial class Globals : Node
{
    ...
    public int RandomTimerForActionEventInactivity { get => _randomTimerForActionEventInactivity; set => _randomTimerForActionEventInactivity = value; }
    [Export] private int _randomTimerForActionEventAcceptance = 10;
    public int RandomTimerForActionEventAcceptance { get => _randomTimerForActionEventAcceptance; set => _randomTimerForActionEventAcceptance = value; }
    ...
    public int DecreaseFinalDeadlineAmount { get => _decreaseFinalDeadlineAmount; set => _decreaseFinalDeadlineAmount = value; }
